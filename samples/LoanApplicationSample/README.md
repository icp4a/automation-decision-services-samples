...
- Websphere Application Server Liberty: A Java application server that you can download from [Download WAS Liberty](https://www.ibm.com/support/pages/websphere-liberty-developers/). This sample was tested on **WebSphere Liberty Web Profile 8 25.0.1.4**.
