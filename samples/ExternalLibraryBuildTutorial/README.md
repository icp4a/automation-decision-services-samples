...
**Note**: if you don't get the BUILD SUCCESS message, it means the sample library has not been deployed to your repository manager. This could be because it was already deployed with the version number `2500.3.0`. To check, follow these steps:

1. Open your ***Artifact repository manager** release repository, as provided in the previous step.
2. Look for `ads/samples/adsSampleLibrary/2500.3.0`. If it exists, the sample library has already been deployed. 
3. If you want to deploy another version, change the version from `2500.3.0` to your desired version, for example, `1.myInitials`, in the following XML files:
...
5. Enter the following values:
  ...
  - Version: 2500.3.0 (This is the version number you deployed in the previous task. If you deployed a different version, use that version number instead.)
