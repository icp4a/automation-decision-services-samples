...
Get the deployed version number from the integrator. This tutorial uses the version 2500.3.0.
...
5. Enter the following values:
  ...
  - Version: 2500.3.0 (This is the version you want to use. It might be different if you deployed a new version.)
