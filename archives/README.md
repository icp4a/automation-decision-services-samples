...
This directory contains decision services archives that can be run in your Decision Intelligence Client Managed Software runtime or using the execution api. 
They were built from the decision services that can be loaded in Designer using the 
samples wizard (see `Building decision services in Decision Designer`[![CP4BA](/resources/cloudpak4ba.svg "IBM Cloud Pak for Business Automation")](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/26.0.0?topic=software-building-decision-services-in-decision-designer)[![ADS](/resources/ads.svg "IBM Decision Intelligence Client Managed Software")](https://www.ibm.com/docs/en/dicms/26.0.0?topic=software-building-decision-services-in-decision-designer)).
...
For more information, see `Executing decision services with decision runtime documentation`[![CP4BA](/resources/cloudpak4ba.svg "IBM Cloud Pak for Business Automation")](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/26.0.0?topic=services-executing-decision-decision-runtime)[![ADS](/resources/ads.svg "IBM Decision Intelligence Client Managed Software")](https://www.ibm.com/docs/en/dicms/26.0.0?topic=services-executing-decision-decision-runtime).

## Prerequisites
- Decision Intelligence: Your instance of the services must have a runtime. You must have the credentials allowing management and execution in this runtime. 

To use an archive containing a predictive model:
- **Decision Intelligence Machine Learning Service**: A Machine Learning service implementation based on IBM Open Prediction Service API. Ask your IT the URL to access it.
...
1. Download the .jar file that you want to deploy to your computer, for example, `baggage.jar`.
...
4. Deploy the archive by expanding `POST /deploymentSpaces/{deploymentSpaceId}/decisions/{decisionId}/archive` in the **Decision storage management** part, entering the following parameters, and running the operation:
   ...
   * *decisionId*: Use the example `baggage.jar`.
