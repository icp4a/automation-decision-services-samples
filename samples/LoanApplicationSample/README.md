...
1. Download the archive [loanApproval-23.0.1.jar](../../archives/loanApproval-23.0.1.jar)  in a local directory.
...
3. Give the following parameters:
   - deploymentSpaceId `ADSsample`.
   - decisionId `loanApproval-23.0.1`
   - in the request body browse to the `loanApproval-23.0.1.jar` archive you downloaded.
4. Click on Execute.
...
- To undeploy the archive:
    ...
    4. Give `ADSsample` as the deploymentSpaceId and `loanApproval-23.0.1` as the decisionId .
