...
5. The response code is 200. If `loanApproval-23.0.2` is in the response list, you can skip the rest and go to the next section **Getting the execution trace**. 
...
2. Enter the following parameters:
   ...
   - In the request body, browse to the `ADSSamples/archives/loanApproval-23.0.2.jar` archive that you downloaded.
3. Click Execute.
