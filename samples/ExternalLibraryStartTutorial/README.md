...
2. Look for `ads/samples/adsSampleLibrary/1.6.3.5`. If it exists, the sample library is already deployed. You can go to Task 2 directly. If the file does not exist, you must deploy it.

**Note**: If you want to deploy another version, change the version from `1.6.3.5` to the version number that you want to use, for example, `1.myInitials`, in the following XML files:
...
2. Look at the property definitions:
    ...
    * `ads-mojo.version` The version that is used to build the library. (**Note:** This sample was tested with Mojo 12.0.3.4)
    * `ads-annotations.version` The version that is used to build the library. (**Note:** This sample was tested with annotations 2.0.5.01)
...
```
   <properties>
       ...
       <ads-mojo.version>12.0.3.4</ads-mojo.version>
       <ads-annotations.version>2.0.5.01</ads-annotations.version>
   </properties>
```
...
5. Enter the following values:
  ...
  - Version: 1.6.3.5 (This is the version you want to use. It might be different if you deployed a new version.)
