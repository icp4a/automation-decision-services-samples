...
5. The response code is 200. If `loanApproval-23.0.1` is in the response list, you can skip the rest and go to the next section **Getting the execution trace**. 
...
2. Enter the following parameters:
   ...
   - decisionId `loanApproval-23.0.1`.
   - In the request body, browse to the `ADSSamples/archives/loanApproval-23.0.1.jar` archive that you downloaded.
3. Click Execute.
...
Note that the engineVersion might be different from the screenshot.
