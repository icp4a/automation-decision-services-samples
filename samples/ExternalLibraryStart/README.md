...
In IBM Automation Decision Services, you can use external libraries in decision services.
...
- **Decision Designer**: The web-based user interface for developing decision projects in IBM Business Automation Studio. You work with a sample decision service by importing it into a decision project and opening it in Decision Designer.
...
Open this [link](https://github.com/icp4a/automation-decision-services-samples/tree/20.0.3) and choose `Download Zip` in the `Code` menu.
...
4. Enter a name for the project. Use a unique name. Do not reuse the name of a decision project that already exists in your instance of Business Automation Studio. For simplicity, we use `Library Sample` in this sample documentation. After entering your name for the decision project, enter the following description:
...
6. Click the three dots next to your project name to open the contextual menu and select **Settings**.
7. Open the **External libraries** tab and click **Import**.
...
**Note:** You can use the CI/CD stack that is associated with Decision Designer to publish, build, and deploy your decision service. Follow the instructions in the [Use CI/CD stack tutorial](https://github.com/icp4a/automation-decision-services-samples/tree/20.0.3/samples/UseCICDStack).
