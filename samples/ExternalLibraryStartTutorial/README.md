...
In Decision Intelligence Client Managed Software, external libraries can be used in decision services to extend rule authoring with custom data types and functions from Java libraries.
...
This sample is intended for a business user who wants to use a Java library in Decision Intelligence, with the library made available by an integrator.
...
Get the deployed version number from the integrator. This tutorial uses the version 2600.0.3.
...
- Explore the external library.
 ...
 In this step, you create a project that uses the external library. If you need more details to follow the instructions, please refer to the `Getting started in Decision Intelligence`[![CP4BA](/resources/cloudpak4ba.svg "IBM Cloud Pak for Business Automation")](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/26.0.0?topic=resources-getting-started)[![ADS](/resources/ads.svg "IBM Decision Intelligence Client Managed Software")](https://www.ibm.com/docs/en/dicms/26.0.0?topic=resources-getting-started) tutorial.
...
5. Enter the following values:
  ...
  - Version: 2600.0.3 (This is the version you want to use. It might be different if you deployed a new version.)
...
In this task you run a decision service that includes an external library in the same way as any other decision service. These steps are more detailed than those in task 6 of `Getting started in Decision Intelligence`[![CP4BA](/resources/cloudpak4ba.svg "IBM Cloud Pak for Business Automation")](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/26.0.0?topic=resources-getting-started)[![ADS](/resources/ads.svg "IBM Decision Intelligence Client Managed Software")](https://www.ibm.com/docs/en/dicms/26.0.0?topic=resources-getting-started).
